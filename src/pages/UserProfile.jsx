  ...
  return isLoading ? (
    ...
    <>
      ...
      <div className="flex justify-between">
        <div className="flex">
          <h1 className="font-black text-3xl h-min">{user.name}</h1>
          <p className="text-lg ml-10 bg-green-600 h-min py-2 px-4 rounded-full text-white font-bold">
            {user.blocked ? 'Blocked' : `# ${user.customer_id}`}
          </p>
        </div>
        <div className=" float-right gap-2 text-gray-400 hover:text-yellow-600 cursor-pointer">
          <svg
      ...
      <div className="float-right gap-2 mt-2 text-gray-400 hover:text-red-600 cursor-pointer">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-6 w-6 m-auto"
          fill="none"
      ...
      {user.blocked && (
        <div className="float-right w-40 gap-2 mt-2 text-gray-400 hover:text-green-600 cursor-pointer">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-6 w-6 m-auto"
            fill="none"
          ...
          <button
            type="button"
            className="uppercase font-bold text-center px-10"
          >
            Unblock
          </button>
        </div>
